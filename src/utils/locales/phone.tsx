...
export const countriesPhone: readonly CountryType[] = [
  ...
  { name: 'Bouvet Island', code: 'BV', phone: '' }, // No phone code
  ...
  { name: 'French Southern Territories', code: 'TF', phone: '' }, // No phone code
  ...
  { name: 'Heard Island and Mcdonald Islands', code: 'HM', phone: '' }, // No phone code
  ...
  { name: 'Pitcairn', code: 'PN', phone: '+870' }, // Not a regular country code, used for Pitcairn Island only
  { name: 'Poland', code: 'PL', phone: '+48' },
  { name: 'Portugal', code: 'PT', phone: '+351' },
  { name: 'Puerto Rico', code: 'PR', phone: '+1-787 and 1-939' },
  ...
  { name: 'Serbia and Montenegro', code: 'CS', phone: '+381' }, // Deprecated code, replaced by RS and ME
